...
pub static  THERMAL_GRADIENT_DEFAULT: Lazy<ThermalGradient> = Lazy::new(|| {
    ThermalGradient::new(vec![
        ThermalGradientPoint::from_rgbtemp(0, 0, 0, 10),
...
impl ThermalGradientPoint {
    ...
    pub fn from_rgbtemp(r: u8, g: u8, b: u8, temp: u16) -> Self {
        Self {
...
pub struct ThermalGradient {
    points: Vec<ThermalGradientPoint>,
}
impl ThermalGradient {
    pub fn new(points: Vec<ThermalGradientPoint>) -> Self {
        let mut me = Self { points: points };
        me.points
